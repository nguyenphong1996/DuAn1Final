...
public class DbHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        String sql = "CREATE TABLE NGUOIDUNG(id_nguoidung integer primary key autoincrement, user text, pass text, email text)";
        sqLiteDatabase.execSQL(sql);
        sql = "INSERT INTO NGUOIDUNG (user, pass, email) VALUES" +
